...
$retrieve_posts = mysql_query("SELECT title, diary_entry_text, diary_entry_multimedia FROM diaryentry WHERE student_id=$temp");
                    ...
                    <li>
                        <form>
                            <div class="input-field" style="position: relative">
                                <input id="search" type="search" required placeholder="Search..." style="background:white; height:36px; margin-top:15px; padding-left: 5px; color:#502580;">
                                        ...
                                        <!--
                                            <form class="col s12" method="post" action="">
                                                <div class="row">
                                                    <div class="input-field col s12">
                                                        <i class="material-icons prefix">person</i>
                                                        <input id="student_name" name="post_title" type="text">
                                                        <label for="student_name" data-error="Invalid">Name</label>
                                                    </div>
                                                </div>
                                                <div class="row">
